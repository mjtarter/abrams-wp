...
get_header(); ?>
  ...
  <section id="page-title">
    ...
    <div class="container clearfix">
      <h1><?php the_field('procedure_name'); ?></h1>
      <ol class="breadcrumb">
        <li><a href="<?php bloginfo('url'); ?>/procedures">Eye Procedures</a></li>
        <li class="active"><?php the_field('procedure_name'); ?></li>
      </ol>
    </div>
  ...
  <div class="container white-bg ptb-50" id="lasik">
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="text-center"><a href="<?php bloginfo('url'); ?>/procedures" class="button button-3d button-rounded button-blue">Back to Eye Procedures Home</a></div>
      </div>
    </div>
    <hr>
    <div class="row">
